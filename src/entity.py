...
class Ent:
    ...
    def __init__(self, x_pos: float, y_pos: float, filepath: str, animation_steps: int = 1)  -> None:
        ...
        self.sprites = SpriteSheet(image, animation_steps, self.size.x, self.size.y)
